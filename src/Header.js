    ...
    return(
        <div className="header">
            ...
            <div className="header__options">
                    <span className="header__optionOne">Delivering to Mumbai 400001</span>
            ...
            <div className="header_search">
                ...
                <div className="header__options">
                <a href="www.google.com">
                    <span className="header__optionT">
                ...
                <div className="header_optionBasket">
                    <ShoppingBasketIcon />
                    <span className="header__optionTwo header_countBasket">{basket?.length}</span>
                </div>
                </Link>
            </div>
            <Outlet />
